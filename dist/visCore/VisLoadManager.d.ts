...
export declare enum VisLoaderManagerEventType {
    LOADING = "loading",
    DETAILLOADING = "detailLoading",
    DETAILLOADED = "detailLoaded",
    LOADED = "loaded"
}
export declare class VisLoaderManager extends EventDispatcher<LoadingEvent | DetailEvent | LoadedEvent> {
    private resourceMap;
    private loaderMap;
    private loadTotal;
    private loadSuccess;
...
//# sourceMappingURL=VisLoadManager.d.ts.map