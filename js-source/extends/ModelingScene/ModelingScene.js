...
(function (SCENEDISPLAYMODE) {
    SCENEDISPLAYMODE["GEOMETRY"] = "geometry";
    SCENEDISPLAYMODE["MATERIAL"] = "material";
    SCENEDISPLAYMODE["LIGHT"] = "light";
    SCENEDISPLAYMODE["ENV"] = "env";
...
export class ModelingScene extends Scene {
    ...
    updateMaterial(object) {
        ...
        if (this.displayMode !== undefined && this.displayMode === 'geometry') {
