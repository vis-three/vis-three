...
export interface WidgetOptions {
    ...
    parent: string;
    render: (e: (type: CONFIGTYPE, merge: any) => ReturnType<typeof CONFIGFACTORY[CONFIGTYPE]>, c: () => any, onComputed: (fun: () => any) => Symbol, onEvent: (fun: (event?: ObjectEvent) => void) => void, onResource: (url: string) => any) => Record<string, ReturnType<typeof CONFIGFACTORY[CONFIGTYPE]>>;
