(function(s,u){typeof exports=="object"&&typeof module!="undefined"?u(exports,require("@vis-three/core"),require("@vis-three/utils"),require("@vis-three/plugin-selection"),require("@vis-three/plugin-effect-composer"),require("three"),require("three/examples/jsm/postprocessing/Pass"),require("three/examples/jsm/shaders/CopyShader.js")):typeof define=="function"&&define.amd?define(["exports","@vis-three/core","@vis-three/utils","@vis-three/plugin-selection","@vis-three/plugin-effect-composer","three","three/examples/jsm/postprocessing/Pass","three/examples/jsm/shaders/CopyShader.js"],u):(s=typeof globalThis!="undefined"?globalThis:s||self,u((s["vis-three"]=s["vis-three"]||{},s["vis-three"]["strategy-selection-prompt"]={}),s.core,s.utils,s.pluginSelection,s.pluginEffectComposer,s.three,s.Pass,s.CopyShader_js))})(this,function(s,u,d,m,S,r,p,c){"use strict";var w=Object.defineProperty;var E=(s,u,d)=>u in s?w(s,u,{enumerable:!0,configurable:!0,writable:!0,value:d}):s[u]=d;var t=(s,u,d)=>(E(s,typeof u!="symbol"?u+"":u,d),d);const B="@vis-three/strategy-selection-prompt",f=class extends p.Pass{constructor(e,l,i){super();t(this,"renderCamera");t(this,"renderScene",new r.Scene);t(this,"resolution",new r.Vector2(256,256));t(this,"selected",[]);t(this,"visibleEdgeColor",new r.Color(1,1,1));t(this,"hiddenEdgeColor",new r.Color(.1,.04,.02));t(this,"edgeGlow",0);t(this,"usePatternTexture",!1);t(this,"edgeThickness",1);t(this,"edgeStrength",3);t(this,"downSampleRatio",2);t(this,"pulsePeriod",0);t(this,"patternTexture",null);t(this,"msaa",4);t(this,"_oldClearColor",new r.Color);t(this,"oldClearAlpha",1);t(this,"fsQuad",new p.FullScreenQuad(void 0));t(this,"tempPulseColor1",new r.Color);t(this,"tempPulseColor2",new r.Color);t(this,"textureMatrix",new r.Matrix4);t(this,"renderTargetBlurBuffer1");t(this,"renderTargetBlurBuffer2");t(this,"renderTargetMaskBuffer");t(this,"renderTargetDepthBuffer");t(this,"renderTargetMaskDownSampleBuffer");t(this,"renderTargetEdgeBuffer1");t(this,"renderTargetEdgeBuffer2");t(this,"depthMaterial",new r.MeshDepthMaterial({side:r.DoubleSide,depthPacking:r.RGBADepthPacking,blending:r.NoBlending}));t(this,"prepareMaskMaterial",new r.ShaderMaterial({uniforms:{depthTexture:{value:null},cameraNearFar:{value:new r.Vector2(.5,.5)},textureMatrix:{value:null}},vertexShader:`#include <morphtarget_pars_vertex>
      ...
      }`,blending:r.AdditiveBlending,depthTest:!1,depthWrite:!1,transparent:!0}));t(this,"materialCopy",new r.ShaderMaterial({uniforms:r.UniformsUtils.merge([r.UniformsUtils.clone(c.CopyShader.uniforms),{opacity:{value:1}}]),vertexShader:c.CopyShader.vertexShader,fragmentShader:c.CopyShader.fragmentShader,blending:r.NoBlending,depthTest:!1,depthWrite:!1,transparent:!0}));t(this,"cacheParents",new Map);this.resolution.copy(e),this.renderCamera=l,this.selected=i;const a=Math.round(this.resolution.x/this.downSampleRatio),o=Math.round(this.resolution.y/this.downSampleRatio);this.renderTargetMaskBuffer=new r.WebGLRenderTarget(this.resolution.x,this.resolution.y,{samples:this.msaa}),this.renderTargetMaskBuffer.texture.name="OutlinePass.mask",this.renderTargetMaskBuffer.texture.generateMipmaps=!1;const n=l.isPerspectiveCamera?"perspective":"orthographic";this.prepareMaskMaterial.fragmentShader=this.prepareMaskMaterial.fragmentShader.replace(/DEPTH_TO_VIEW_Z/g,n+"DepthToViewZ"),this.renderTargetDepthBuffer=new r.WebGLRenderTarget(this.resolution.x,this.resolution.y,{samples:this.msaa}),this.renderTargetDepthBuffer.texture.name="OutlinePass.depth",this.renderTargetDepthBuffer.texture.generateMipmaps=!1,this.renderTargetMaskDownSampleBuffer=new r.WebGLRenderTarget(a,o),this.renderTargetMaskDownSampleBuffer.texture.name="OutlinePass.depthDownSample",this.renderTargetMaskDownSampleBuffer.texture.generateMipmaps=!1,this.renderTargetBlurBuffer1=new r.WebGLRenderTarget(a,o),this.renderTargetBlurBuffer1.texture.name="OutlinePass.blur1",this.renderTargetBlurBuffer1.texture.generateMipmaps=!1,this.renderTargetBlurBuffer2=new r.WebGLRenderTarget(Math.round(a/2),Math.round(o/2)),this.renderTargetBlurBuffer2.texture.name="OutlinePass.blur2",this.renderTargetBlurBuffer2.texture.generateMipmaps=!1,this.renderTargetEdgeBuffer1=new r.WebGLRenderTarget(a,o),this.renderTargetEdgeBuffer1.texture.name="OutlinePass.edge1",this.renderTargetEdgeBuffer1.texture.generateMipmaps=!1,this.renderTargetEdgeBuffer2=new r.WebGLRenderTarget(Math.round(a/2),Math.round(o/2)),this.renderTargetEdgeBuffer2.texture.name="OutlinePass.edge2",this.renderTargetEdgeBuffer2.texture.generateMipmaps=!1;const g=4,M=4;this.separableBlurMaterial1=this.getSeperableBlurMaterial(g),this.separableBlurMaterial1.uniforms.texSize.value.set(a,o),this.separableBlurMaterial1.uniforms.kernelRadius.value=1,this.separableBlurMaterial2=this.getSeperableBlurMaterial(M),this.separableBlurMaterial2.uniforms.texSize.value.set(Math.round(a/2),Math.round(o/2)),this.separableBlurMaterial2.uniforms.kernelRadius.value=M,this.enabled=!0,this.needsSwap=!1}getSeperableBlurMaterial(e){return new r.ShaderMaterial({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new r.Vector2(.5,.5)},direction:{value:new r.Vector2(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
