...
import { SELECTION_PLUGIN, SELECTED } from "@vis-three/plugin-selection";
import { EFFECT_COMPOSER_PLUGIN } from "@vis-three/plugin-effect-composer";
import { Vector2, Scene, Color, Matrix4, MeshDepthMaterial, DoubleSide, RGBADepthPacking, NoBlending, ShaderMaterial, Vector3, AdditiveBlending, UniformsUtils, WebGLRenderTarget } from "three";
import { Pass, FullScreenQuad } from "three/examples/jsm/postprocessing/Pass";
import { CopyShader } from "three/examples/jsm/shaders/CopyShader.js";
const name = "@vis-three/strategy-selection-prompt";
const _SelectionOutlinePass = class extends Pass {
  constructor(resolution, camera, selected) {
    super();
    __publicField(this, "renderCamera");
    __publicField(this, "renderScene", new Scene());
    __publicField(this, "resolution", new Vector2(256, 256));
    __publicField(this, "selected", []);
    __publicField(this, "visibleEdgeColor", new Color(1, 1, 1));
    __publicField(this, "hiddenEdgeColor", new Color(0.1, 0.04, 0.02));
    __publicField(this, "edgeGlow", 0);
    __publicField(this, "usePatternTexture", false);
    __publicField(this, "edgeThickness", 1);
    __publicField(this, "edgeStrength", 3);
    __publicField(this, "downSampleRatio", 2);
    __publicField(this, "pulsePeriod", 0);
    __publicField(this, "patternTexture", null);
    __publicField(this, "msaa", 4);
    __publicField(this, "_oldClearColor", new Color());
    __publicField(this, "oldClearAlpha", 1);
    __publicField(this, "fsQuad", new FullScreenQuad(void 0));
    __publicField(this, "tempPulseColor1", new Color());
    __publicField(this, "tempPulseColor2", new Color());
    __publicField(this, "textureMatrix", new Matrix4());
    ...
    __publicField(this, "prepareMaskMaterial", new ShaderMaterial({
      uniforms: {
    ...
    __publicField(this, "edgeDetectionMaterial", new ShaderMaterial({
      uniforms: {
    ...
    __publicField(this, "overlayMaterial", new ShaderMaterial({
      uniforms: {
        maskTexture: { value: null },
    ...
    __publicField(this, "materialCopy", new ShaderMaterial({
  ...
  render(renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
    if (this.selected.length > 0) {
      ...
      this.materialCopy.uniforms["tDiffuse"].value = this.renderTargetMaskBuffer.texture;
      ...
      this.separableBlurMaterial1.uniforms["direction"].value = _SelectionOutlinePass.BlurDirectionX;
      this.separableBlurMaterial1.uniforms["kernelRadius"].value = this.edgeThickness;
      renderer.setRenderTarget(this.renderTargetBlurBuffer1);
      renderer.clear();
      this.fsQuad.render(renderer);
      this.separableBlurMaterial1.uniforms["colorTexture"].value = this.renderTargetBlurBuffer1.texture;
      this.separableBlurMaterial1.uniforms["direction"].value = _SelectionOutlinePass.BlurDirectionY;
      renderer.setRenderTarget(this.renderTargetEdgeBuffer1);
      renderer.clear();
      this.fsQuad.render(renderer);
      this.fsQuad.material = this.separableBlurMaterial2;
      this.separableBlurMaterial2.uniforms["colorTexture"].value = this.renderTargetEdgeBuffer1.texture;
      this.separableBlurMaterial2.uniforms["direction"].value = _SelectionOutlinePass.BlurDirectionX;
      renderer.setRenderTarget(this.renderTargetBlurBuffer2);
      renderer.clear();
      this.fsQuad.render(renderer);
      this.separableBlurMaterial2.uniforms["colorTexture"].value = this.renderTargetBlurBuffer2.texture;
      this.separableBlurMaterial2.uniforms["direction"].value = _SelectionOutlinePass.BlurDirectionY;
...
let SelectionOutlinePass = _SelectionOutlinePass;
__publicField(SelectionOutlinePass, "BlurDirectionX", new Vector2(1, 0));
__publicField(SelectionOutlinePass, "BlurDirectionY", new Vector2(0, 1));
const SELECTION_PROMPT_STRATEGY = transPkgName(name);
const SelectionPromptStrategy = function(params = {}) {
  let setCameraFun;
  let selectionFun;
  let pass;
  return {
    ...
    exec(engine) {
      ...
      setCameraFun = (event) => {
        pass.renderCamera = event.camera;
      };
...
export { SELECTION_PROMPT_STRATEGY, SelectionPromptStrategy };
