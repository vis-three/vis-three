import { Camera, Matrix4, Object3D, Object3DEventMap, Quaternion, Raycaster, Scene, Vector3 } from "three";
...
export interface TransformControlsEventMap extends Object3DEventMap {
    ...
    [TRANSFORM_EVENT.CHANGE]: {
        mode: "scale" | "position" | "rotation";
        transObjectSet: Set<Object3D<Object3DEventMap>>;
    };
    [TRANSFORM_EVENT.OBJECT_CHANGE]: {
        mode: "scale" | "position" | "rotation";
        transObjectSet: Set<Object3D<Object3DEventMap>>;
    };
    [TRANSFORM_EVENT.MOUSE_UP]: {
        mode: "scale" | "position" | "rotation";
    };
}
declare class TransformControls extends Object3D<TransformControlsEventMap> {
