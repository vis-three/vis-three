...
export declare const raycastHandler: <C extends ObjectConfig, O extends Object3D<import("three").Event>>({ target, config, value, engine, }: ProcessParams<C, O, EngineSupport, ObjectCompiler<C, O>>) => void;
export declare const objectCreate: <C extends ObjectConfig, O extends Object3D<import("three").Event>>(object: O, config: C, filter: IgnoreAttribute<C>, engine: EngineSupport) => O;
