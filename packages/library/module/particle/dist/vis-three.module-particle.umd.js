(function(o,r){typeof exports=="object"&&typeof module!="undefined"?module.exports=r(require("@vis-three/middleware"),require("@vis-three/module-object"),require("uuid"),require("three")):typeof define=="function"&&define.amd?define(["@vis-three/middleware","@vis-three/module-object","uuid","three"],r):(o=typeof globalThis!="undefined"?globalThis:o||self,o["vis-three"]=o["vis-three"]||{},o["vis-three"]["module-particle"]=r(o.middleware,o.moduleObject,o.uuid,o.three))})(this,function(o,r,s,u){"use strict";var M=Object.defineProperty;var P=(o,r,s)=>r in o?M(o,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):o[r]=s;var f=(o,r,s)=>(P(o,typeof r!="symbol"?r+"":r,s),s);class m extends r.ObjectCompiler{constructor(){super()}}const d=function(e,a,t=s.validate){r.ObjectRule(e,a,t)},p=function(){return Object.assign(r.getObjectConfig(),{range:{top:100,bottom:-100,left:-100,right:100,front:100,back:-100},amount:200,size:1,alphaMap:"",opacity:1,flicker:!0,time:0,floatRange:5,refColor:"rgb(255, 255, 255)",colorRange:.5})},h=`
varying vec3 vColor;
