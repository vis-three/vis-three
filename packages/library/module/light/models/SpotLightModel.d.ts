...
declare const _default: import("@vis-three/tdcm").ModelOption<SpotLightConfig, SpotLight, import("@vis-three/module-object").ObjectModelContext & import("./LightModel").LightContext & object, import("@vis-three/module-object").ObjectModelShared & import("./LightModel").LightShared & object, import("./LightModel").WebGLRendererEngineSupport, import("@vis-three/tdcm").Compiler<import("./LightModel").WebGLRendererEngineSupport>, Record<string, import("@vis-three/tdcm").LoadUnit>>;
