            ...
            "/en/start/": [
                {
                    items: [
                        ...
                        {text: "Configuration-Driven Development", link: "/en/start/config"},
                        {text: "Component-Based Development (Alpha)", link: "/en/start/widget"},
                        {text: "Configurable Framework Integration", link: "/en/start/combine"},
