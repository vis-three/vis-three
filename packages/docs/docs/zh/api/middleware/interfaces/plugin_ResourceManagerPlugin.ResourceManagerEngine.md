# Interface: ResourceManagerEngine

[plugin/ResourceManagerPlugin](../modules/plugin_ResourceManagerPlugin.md).ResourceManagerEngine
...
▸ **dispose**(): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **render**(`delta`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **rollback**(`name`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **setCamera**(`camera`, `options?`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **setDom**(`dom`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **setScene**(`scene`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **setSize**(`width?`, `height?`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
...
▸ **uninstall**(`name`): [`ResourceManagerEngine`](plugin_ResourceManagerPlugin.ResourceManagerEngine.md)
