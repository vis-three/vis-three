...
export type KeyCommand<C extends SymbolConfig, T extends object> = (params: ProcessParams<C, T>) => void;
export type CommandStructure<C extends SymbolConfig, T extends object> = DeepIntersection<DeepPartial<DeepRecord<DeepUnion<C, KeyCommand<C, T>>, KeyCommand<C, T>>>, {
    $reg?: RegCommand<C, T>[];
}>;
...
export type DefineProcessor = <C extends SymbolConfig, T extends object>(options: ProcessorOptions<C, T>) => Processor<C, T>;
