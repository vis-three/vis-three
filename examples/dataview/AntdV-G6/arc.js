...
arcGraph.on("edge:mouseenter", function (e) {
  const edge = e.item;
  arcGraph.setItemState(edge, "hover", true);
});
arcGraph.on("edge:mouseleave", function (e) {
  const edge = e.item;
  arcGraph.setItemState(edge, "hover", false);
});
